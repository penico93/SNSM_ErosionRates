...
library(pracma)
# /Users/penico93/Dropbox/Caudales_SNSM/R_codes
...
plot(table$Segundos,table$GASTO_SOLIDO.Kg.s., main="Suspended Load (Kg/s) vs. Time (s)", sub="Cantaclaro 1984-2005",
...
plot(table$Segundos,table$CAUDAL_LIQUIDO.m3.s., main="Water Discharge (m3/s) vs. Time (s)", sub="Cantaclaro 1984-2005",
