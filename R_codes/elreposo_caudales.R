...
setwd(directory)
table <- read.xlsx("elreposo.xlsx",1, header = TRUE)


#Nombre de la estacion

station_name = "El Reposo"
...
plot(table$Segundos,table$GASTO_SOLIDO.Kg.s., main="Suspended Load (Kg/s) vs. Time (s)", sub="El reposo",
...
plot(table$Segundos,table$CAUDAL_LIQUIDO.m3.s., main="Water Discharge (m3/s) vs. Time (s)", sub=" El reposo ",
...
table2 <- read.xlsx("caudalmedio_elreposo.xlsx",1, header = TRUE)
